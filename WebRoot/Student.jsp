	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu">
					<a href="#"><i class="icon icon-th-list"></i> <span>填写志愿</span> <span class="label">2</span></a>
					<ul>
		...
		<div id="content">
		 <form action="finish/student_save" method="post" class="form-horizontal" />
			...
			<table class="table table-bordered table-striped">
					            ...
					            <td valign="top"><input type="text" style="border:0px;" name="uname" value="${studentlist.sname}" readonly/></td> 
					...
					<table class="table table-bordered table-striped">
					            ...
					            <tr>
					              <c:forEach var="studentlist" items="${studentlist}">   
					            <td valign="top"><input type="text" style="border:0px;" name="uname" value="${studentlist.sex}" readonly/></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="time" value="${studentlist.birth}" readonly/></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="time" value="${studentlist.tel}" readonly/></td> 
					            </c:forEach>
					            </tr>
									</tbody>
			...
			<table class="table table-bordered table-striped">
									...
									<tbody>
					            <tr>
					             <c:forEach var="sel" items="${seletedlist}">   
					            <td valign="top"><input type="text" style="border:0px;" name="wanted1" value="${sel}" readonly/></td> 
					            		 </c:forEach>
					             <td valign="top"><input type="text" style="border:0px;" name="last" value="${finalteacher.tname}" readonly/></td>
					            </tr>
									</tbody>
