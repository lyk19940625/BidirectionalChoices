        ...
        <div id="loginbox">            
            <form action="login/check" method="POST"  >
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-lock"></i></span><input type="password" placeholder="密码" name=spwd />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-lock"></i></span><select class="center-block" name="type">
												<option  value="1"/>学生
													<option  value="2"/>教师
														<option  value="3"/>负责人
														   <option  value="4"/>管理员
