			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="widget-box">
						  ...
						  <form action="manager/updatestudent" method="post">
					            ...
					            <td valign="top"><input type="text" style="border:0px;" name="eid" value="${student.eid}" /></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="sname" value="${student.sname}" /></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="spwd" value="${student.spwd}" /></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="sex" value="${student.sex}" /></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="birth" value="${student.birth}" /></td>
					            <td valign="top"><input type="text" style="border:0px;" name="mno" value="${student.mno}" /></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="tel" value="${student.tel}" /></td> 
