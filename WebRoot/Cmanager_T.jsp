...
<html lang="en">
	...
	<body>
		...
		<table class="table table-bordered table-striped">
									...
									<tbody>
									 <c:forEach var="cteacher" items="${cteacherlist}">   
					            <tr>
					         
					            <td valign="top"><input type="text" style="border:0px;" name="tid" value="${cteacher.tid}"/></td> 
					              <td valign="top"><input type="text" style="border:0px;" name="tname" value="${cteacher.tname}" /></td>
					                 <c:forEach var="student" items="${cteacher.students}">    
					                <td valign="top"><input type="text" style="border:0px;"  value="${student.sname}" /></td>
