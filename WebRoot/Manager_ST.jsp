	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu">
					<a href="#"><i class="icon icon-th-list"></i> <span>学院信息信息</span> <span class="label">8</span></a>
					<ul>
				...
				<li><a href="student/querys"><i class="icon icon-pencil"></i> <span>导入学生信息</span></a></li>
					<li><a href="ManagerSelect.jsp"><i class="icon icon-pencil"></i> <span>查看导师选择信息</span></a></li>
						<li><a href="Manager_Open.jsp"><i class="icon icon-pencil"></i> <span>开启关闭系统</span></a></li>
					...
					<div class="span12">
					            ...
					            <tr>
					              <c:forEach var="student" items="${studentlist}"> 
					               <td valign="top"><input type="text" style="border:0px;" name="sid" value="${student.sid}" /></td> 
					           <td valign="top"><input type="text" style="border:0px;" name="sname" value="${student.sname}" /></td> 
					           <td valign="top"><input type="text" style="border:0px;" name="sex" value="${student.sex}" /></td> 
					            <td valign="top"><input type="text" style="border:0px;" name="tips" value="${student.tips}" /></td> 
					           ...
					           <td valign="top"><input type="text" style="border:0px;" name="tid" value="${teacher.tid}" /></td> 
					           <td valign="top"><input type="text" style="border:0px;" name="tname" value="${teacher.tname}" /></td> 
					           <td valign="top"><input type="text" style="border:0px;" name="sex" value="${teacher.sex}" /></td>
					           <td valign="top"><input type="text" style="border:0px;" name="introduction" value="${teacher.introduction}" /></td> 
