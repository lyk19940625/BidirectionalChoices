			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="widget-box">
						  ...
						  <form action="manager/updateteacher" method="post">
								<table class="table table-bordered table-striped">
									...
									<tbody>
					            <tr>
					             <td><input type="text" name="tid" value="${teacher.tid}"/></td>
					               <td><input type="text" name="tname" value="${teacher.tname}"/></td>
					                 <td><input type="text" name="tpwd" value="${teacher.tpwd}"/></td>
					                   <td><input type="text" name="sex" value="${teacher.sex}"/></td>
					                     <td><input type="text" name="birth" value="${teacher.birth}"/></td>
					                      <td><input type="text" name="mno" value="${teacher.mno}"/></td>
					                       <td><input type="text" name="tel" value="${teacher.tel}"/></td>
					                         <td><input type="text" name="introduction" value="${teacher.introduction}"/></td>
