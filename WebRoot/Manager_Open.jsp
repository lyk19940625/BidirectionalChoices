					...
					<div class="widget-box">
							<div class="widget-title">
								<span class="icon">
									...
									<tbody>
					            <tr>
					            <td valign="top">学生选择功能</td> 
					              <td valign="top"><a href="manager/openstudent">开启</a></td>
					               <td valign="top"><a href="manager/closestudent">关闭</a></td>
					             
					            </tr>
					              <tr>
					            <td valign="top">导师选择功能</td> 
					              <td valign="top"><a href="manager/openteacher">开启</a></td>
					               <td valign="top"><a href="manager/closeteacher">关闭</a></td>
					             
					            </tr>
					              <tr>
					            <td valign="top">学科点负责人分配选择功能</td> 
					              <td valign="top"><a href="manager/opencmanager">开启</a></td>
					               <td valign="top"><a href="manager/closecmanager">关闭</a></td>
