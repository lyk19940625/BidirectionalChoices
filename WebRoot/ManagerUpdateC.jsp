			...
			<div class="container-fluid">
				<div class="row-fluid">
					...
					<div class="widget-box">
						  ...
						  <form action="manager/updatecmanager" method="post" >
								<table class="table table-bordered table-striped">
									...
									<tbody>
					            <tr>
					             <td><input type="text" name="cid" value="${cmanager.cid}"/></td>
					               <td><input type="text" name="cname" value="${cmanager.cname}"/></td>
					                 <td><input type="text" name="cpwd" value="${cmanager.cpwd}"/></td>
					                   <td><input type="text" name="sex" value="${cmanager.sex}"/></td>
					                     <td><input type="text" name="college" value="${cmanager.college}"/></td>
					                      <td><input type="text" name="tel" value="${cmanager.tel}"/></td>
